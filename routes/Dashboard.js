...
const { getDashboardData, addCalendarEvent, editProposalStatus, restoreProposal, deleteProposals, setCurrentEditor, deletePermanently, updateProposal, editGrantProposalStatus, setCurrentEditorGrant, restoreGrantProposal, deleteGrantProposals, deletePermanentlyGrant, updateGrantProposal } = require("../controllers/dashboardController");
